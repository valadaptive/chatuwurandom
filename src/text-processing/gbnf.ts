import {SyntaxNodeTransform} from '../util/syntax-node-cache';

const lezerToGBNF: SyntaxNodeTransform<unknown> = (node, children: unknown[] | null, doc, depth): unknown => {
